        ...
        <div className='mx-12 mt-12 bg-blue-50 p-12'>
            ...
            <div className="lg:flex items-center ">
                ...
                <div className='space-y-8'>
                    ...
                    <h3 className='text-3xl lg:text-6xl font-bold'>Meet Our Creative <br /> Event Organizer</h3>
                    <p className='text-xl '>Lorem ipsum dolor sit amet consectetur adipiscing elit <br /> sed doeiusm tempor incididunt.</p>

                    <div className='flex justify-center mt-8'>
                        <button className=' lg:ml-16 bg-[#9ACCC9] duration-500 hover:bg-[#F4A492] px-5 text-xl rounded-3xl  mb-8 lg:mb-0 py-3  mt-4'>View all Services</button>
