...
const Progress = () => {
    return (
        <div className='flex bg-blue-50 mx-12 p-12 justify-center my-16 gap-16'>
            <div className='space-y-3'>
                <p className='text-[#F4A492] text-xl    '>Bridely Fun Facts</p>
                <h2 className='text-6xl font-bold'>Exploring our <br />  Wedding Service</h2>
            ...
            <div className='space-y-3'>
                ...
                <div>
                    ...
                    <progress className="progress progress-success w-96" value="90" max="100"></progress>
                </div>

                <div>
                <p className="text-xl">Professionality</p>
                <progress className="progress progress-success w-96" value="100" max="95"></progress>
                </div>
            </div>
