        ...
        <div className='mx-12 mt-12 bg-blue-50 p-12'>
            ...
            <div className="lg:flex items-center ">
                ...
                <div className='space-y-8'>
                    ...
                    <h3 className='text-3xl lg:text-6xl font-bold'>Includes Various <br /> Product Categories</h3>
                    <p className='text-xl '>Lorem ipsum dolor sit amet consectetur adipiscing elit <br /> sed doeiusm tempor incididunt.</p>

                    <div className='flex justify-center mt-8'>
                        <button className='mb-12 lg:mb-0 lg:ml-16 bg-[#9ACCC9] duration-500 hover:bg-[#F4A492] px-5 text-xl rounded-3xl py-3  mt-4'>View all Services</button>
                ...
                <div className="grid  grid-cols-1 md:grid-cols-2 lg:grid-cols-2 max-w-6xl mx-auto gap-8 ">
                    ...
                    <div className='relative'>
                        <img className="border-8 border-white w-[350px]  lg:h-[300px] rounded-xl" src={img1} />
                        <h2 className='text-center bg-gray-100 py-3 text-xl font-semibold'>Wedding Walls</h2>
                    </div>


                    <div className='relative'>
                        <img className="border-8 border-white w-[350px]  lg:h-[300px] rounded-xl" src={img2} />
                        <h2 className='text-center bg-gray-100 py-3 text-xl font-semibold'>Metal Circles & Flowers</h2>
                    </div>


                    <div className='relative'>
                        <img className="border-8 border-white w-[350px]  lg:h-[300px] rounded-xl" src={img3} />
                        <h2 className='text-center bg-gray-100 py-3 text-xl font-semibold'>Chairs</h2>
                    </div>


                    <div className='relative'>
                        <img className="border-8 border-white w-[350px]  lg:h-[300px] rounded-xl" src={img4} />
